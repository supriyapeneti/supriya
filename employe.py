...
# Streamlit web application with table and bar chart for multiple employees
def main():
    ...
    for i, employee in enumerate(employees):
        ...
        st.subheader(f"Employee {i + 1} Performance Details:")
        st.table({
            'Name': [employee.name],
        ...
        st.subheader(f"Employee {i + 1} Performance Chart:")
